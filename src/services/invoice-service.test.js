...
describe("invoiceService", () => {
  ...
  describe("getAllInvoices", () => {
    ...
    it("should handle database errors when fetching all invoices", async () => {
      ...
      await expect(invoiceService.getAllInvoices()).rejects.toThrow(
        "Database error"
      );
      expect(logger.error).toHaveBeenCalledWith("Error fetching invoices", {
  ...
  describe("getInvoiceById", () => {
    ...
    it("should throw an error when invoice is not found", async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith("Error fetching invoice", {
